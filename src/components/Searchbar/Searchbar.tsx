...
const Searchbar = ({height = "32px", width="33%"}: {height?:string; width?:string}) => (
	<form className="Searchbar" style={{height: height, width: width}}>
		<input type="text" placeholder="Search..." />
		<button style={{height: height, right: 0}}>
