...
const Searchbar = ({height = "48px", width="42%", aspect="1.25/1"}: {height?:string; width?:string; aspect?:string}) => {
	...
	return (
		<div className="Searchbar" style={{height: height, width: width}}>
			<form style={{borderRadius: height, paddingRight: `calc(${height} * 0.1)`}}>
				<input type="text" style={{width: `calc(100% - calc(${height} * ${aspectW}))`}} placeholder="Search..." />
				<button style={{
					height: buttonHeight, 
